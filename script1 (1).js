...
// 🔹 Function to display the current date dynamically on page load
document.addEventListener("DOMContentLoaded", () => {
  let today = new Date(); // Get the current date
  let formattedDate = today.toDateString(); // Format date as "Mon Mar 10 2025"
  document.getElementById("current-date").innerText =
    "Today's Date: " + formattedDate; // Insert formatted date into the HTML
})